classdef ScaraController < BaseController 
    ...
    methods
        function obj=ScaraController(st,j1_inner_controller_, j1_outer_controller_, j1_tau_in_, j1_tau_out_, j2_inner_controller_, j2_outer_controller_, j2_tau_in_, j2_tau_out_)
            % INSERIRE ASSERT SE NECESSARIO
            
            obj@BaseController(st);
            obj.joint1_controller=CascadeController(st,j1_inner_controller_, j1_outer_controller_, j1_tau_in_, j1_tau_out_);
            obj.joint2_controller=CascadeController(st,j2_inner_controller_, j2_outer_controller_, j2_tau_in_, j2_tau_out_);
        end
