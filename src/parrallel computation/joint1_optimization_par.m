function joint1_optimization_par(PM_int, PM_ext, MS_int, MS_ext, w_f)
...
x = [x, 0, 0, 0, 0];
x1 = [x1, 0, 0, 0];
save("parameters_controller_int_joint1_" +num2str(w_f)+"_"+num2str(internal_joint1.PM_min)+"_"+num2str(MS_int)+".mat", "x")
save("parameters_controller_ext_joint1_"+num2str(w_f)+"_"+num2str(external_joint1.PM_min)+"_"+num2str(MS_ext)+".mat","x1")
save("tot_filter_joint1_"+num2str(w_f)+"_"+num2str(internal_joint1.PM_min)+"_"+num2str(external_joint1.PM_min)+"_"+num2str(MS_int)+"_"+num2str(MS_ext)+".mat","tot_filter");
